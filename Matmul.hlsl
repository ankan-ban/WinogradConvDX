...
#if USE_FP16_MATH == 1
RWBuffer<float16_t4>    matrixA    : register(u5);
RWBuffer<float16_t4>    matrixB    : register(u6);
RWBuffer<float16_t4>    matrixC    : register(u7);
#else
RWBuffer<float4>        matrixA    : register(u5);
RWBuffer<float4>        matrixB    : register(u6);
RWBuffer<float4>        matrixC    : register(u7);
#endif
